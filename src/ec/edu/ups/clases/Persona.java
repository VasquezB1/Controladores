...
/////////////////////////////////////////////////////////////////////////////////
    ...
    @Override
    // compareTo hace comparacion para saber cual es mayor
    public int compareTo(Persona t) {
        if (nombre.compareTo(t.getNombre()) >= 1) {
            return 1;
        } else if (nombre.compareTo(t.getNombre()) <= -1) {
            return +1;
        } else {
            return 0;
        }
